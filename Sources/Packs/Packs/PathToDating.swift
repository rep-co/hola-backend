...
extension Pack {
  public static let pathToDating = Pack(
    ...
    description:
      "Это захватывающая игра в вопросы, созданная для того, чтобы раскрыть факты о других игроках. Этот опросник из кратких, но интригующих вопросов требует вашего понимания о своих новых знакомых",
    cards: [
      Card(id: 1, emoji: "📚", text: "В какой книге ты бы изменил конец?"),
      Card(
        id: 2, emoji: "🌟",
        text:
          "Вечером вы бы предпочли поиграть, навестить родственников, посмотреть фильм или почитать?"
      ),
      ...
      Card(
        id: 5, emoji: "🚴",
        text: "Вы бы предпочли: ездить на велосипеде, кататься на лошади или водить машину?"),
      Card(id: 6, emoji: "🎁", text: "Вы любите сюрпризы? Почему нет?"),
      Card(
        id: 7, emoji: "🏛",
        text: "Если бы вы были правителем своей страны, какой первый закон вы бы внесли?"),
      Card(
        id: 8, emoji: "💥",
        text: "Если бы вы были супергероем, то какие суперспособности у вас были бы?"),
      Card(
        id: 9, emoji: "⏰", text: "Если бы вы могли вернуться в прошлое, в каком году вы бы нашли?"),
      Card(
        id: 10, emoji: "🎵",
        text:
          "Если бы вы могли вступить в любую прошлую или нынешнюю музыкальную музыку, то в какую бы вы хотели?"
      ),
      Card(
        id: 11, emoji: "🍽",
        text: "Если бы вы могли есть только одно блюдо на всю вашу жизнь, чтобы это было?"),
      Card(
        id: 12, emoji: "🧹",
        text:
          "Если бы вы могли бы найти помощника, то для чего? Для помощи с уборкой, готовкой или работой на даче?"
      ),
      Card(
        id: 13, emoji: "🎬",
        text: "Если бы снимали фильм о твоей жизни, кто бы сыграл тебя? Какой актер?"),
      Card(
        id: 14, emoji: "👃",
        text: "Если бы тебе надо было пережить одно из пяти чувств, чтобы ты выбрал?"),
      Card(
        id: 15, emoji: "📰",
        text: "Если бы тебе предложили подойти к обложке любого журнала, какой бы ты выбрал?"),
      Card(
        id: 16, emoji: "👶",
        text: "Если бы тебе предложили остаться в одном возрасте навсегда, какой бы ты выбрал?"),
      Card(
        id: 17, emoji: "🇺",
        text: "Если бы тебе предложили стать президентом сегодня, чтобы ты изменился?"),
      Card(id: 18, emoji: "💰", text: "Если бы ты выиграл миллион, что бы купил в первую очередь?"),
      Card(
        id: 19, emoji: "🦸",
        text: "Если бы ты мог воплотить в жизнь вымышленного персонажа, кто бы это был?"),
      Card(id: 20, emoji: "✈", text: "Если бы ты мог сменить страну проживания, куда бы поехал?"),
      Card(
        id: 21, emoji: "🏅", text: "Если бы ты мог побить мировой рекорд, что за рекорд это было бы?"
      ),
      Card(id: 22, emoji: "🏝", text: "Если бы ты попал на необитаемый остров, смог бы выжить?"),
      Card(
        id: 23, emoji: "🎶",
        text:
          "Если каждый раз при входе в комнату начинающая играла одну и ту же мелодию, какую бы ты выбрал?"
      ),
      ...
      Card(
        id: 34, emoji: "📝", text: "Какие три дела вы считаете наиболее необходимыми каждый день?"),
      ...
      Card(
        id: 51, emoji: "😱", text: "Какой персонаж из фильмов ужасов, по-твоему, самый страшный?"),
      ...
      Card(
        id: 64, emoji: "😅",
        text: "Какую самую низкую большую шалость ты достиг в детстве и как тебя за нее наказали?"),
      ...
      Card(
        id: 76, emoji: "🛌",
        text:
          "Помимо предметов первой необходимости, без каких вещей вам еще не придется тратить весь день?"
      ),
      ...
      Card(
        id: 83, emoji: "💰",
        text: "Ты бы решился на ограбление банка, если бы знал, что тебя не поймают?"),
      ...
      Card(
        id: 88, emoji: "💼",
        text: "Чего бы вы хотели большего: выиграть в лотерею или иметь идеальную работу? И почему?"
      ),
